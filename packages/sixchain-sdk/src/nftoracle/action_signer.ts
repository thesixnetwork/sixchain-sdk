...
export const ActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.ActionSigner',
  encode(message: ActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const SetSignerSignature = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.SetSignerSignature',
  encode(message: SetSignerSignature, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const SetSignerParams = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.SetSignerParams',
  encode(message: SetSignerParams, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.ownerAddress !== '') {
