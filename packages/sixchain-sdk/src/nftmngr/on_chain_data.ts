...
export const FlagStatus = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.FlagStatus',
  encode(message: FlagStatus, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const OnChainData = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.OnChainData',
  encode(message: OnChainData, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
