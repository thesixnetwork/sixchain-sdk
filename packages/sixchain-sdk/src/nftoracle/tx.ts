...
export const MsgCreateMintRequest = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateMintRequest',
  encode(message: MsgCreateMintRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
  ...
  fromAmino(object: MsgCreateMintRequestAmino): MsgCreateMintRequest {
    ...
    if (object.requiredConfirm !== undefined && object.requiredConfirm !== null) {
      message.requiredConfirm = BigInt(object.requiredConfirm);
    }
    return message;
  },
  toAmino(message: MsgCreateMintRequest): MsgCreateMintRequestAmino {
    ...
    obj.requiredConfirm = message.requiredConfirm !== BigInt(0) ? (message.requiredConfirm?.toString)() : undefined;
    return obj;
  },
...
export const MsgCreateMintRequestResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateMintRequestResponse',
  encode(message: MsgCreateMintRequestResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
function createBaseMsgSubmitMintResponse(): MsgSubmitMintResponse {
  return {
    creator: '',
    mintRequestID: BigInt(0),
    base64NftData: ''
  };
}
export const MsgSubmitMintResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitMintResponse',
  encode(message: MsgSubmitMintResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.mintRequestID !== BigInt(0)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitMintResponse {
    ...
    while (reader.pos < end) {
      ...
      case 1:
        ...
        break;
      case 2:
        message.mintRequestID = reader.uint64();
        break;
      case 3:
  ...
  fromPartial(object: Partial<MsgSubmitMintResponse>): MsgSubmitMintResponse {
    const message = createBaseMsgSubmitMintResponse();
    message.creator = object.creator ?? '';
    message.mintRequestID = object.mintRequestID !== undefined && object.mintRequestID !== null ? BigInt(object.mintRequestID.toString()) : BigInt(0);
  ...
  fromAmino(object: MsgSubmitMintResponseAmino): MsgSubmitMintResponse {
    ...
    if (object.mintRequestID !== undefined && object.mintRequestID !== null) {
      message.mintRequestID = BigInt(object.mintRequestID);
    }
  ...
  toAmino(message: MsgSubmitMintResponse): MsgSubmitMintResponseAmino {
    const obj: any = {};
    obj.creator = message.creator === '' ? undefined : message.creator;
    obj.mintRequestID = message.mintRequestID !== BigInt(0) ? (message.mintRequestID?.toString)() : undefined;
...
export const MsgSubmitMintResponseResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitMintResponseResponse',
  encode(message: MsgSubmitMintResponseResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const MsgCreateActionRequest = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionRequest',
  encode(message: MsgCreateActionRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.vm !== '') {
...
export const MsgCreateActionRequestResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionRequestResponse',
  encode(message: MsgCreateActionRequestResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== BigInt(0)) {
      writer.uint32(8).uint64(message.id);
    }
    return writer;
...
function createBaseMsgSubmitActionResponse(): MsgSubmitActionResponse {
  return {
    creator: '',
    actionRequestID: BigInt(0),
    base64NftData: ''
  };
}
export const MsgSubmitActionResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitActionResponse',
  encode(message: MsgSubmitActionResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.actionRequestID !== BigInt(0)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitActionResponse {
    ...
    while (reader.pos < end) {
      ...
      case 1:
        ...
        break;
      case 2:
        message.actionRequestID = reader.uint64();
        break;
      case 3:
        message.base64NftData = reader.string();
        break;
  ...
  fromPartial(object: Partial<MsgSubmitActionResponse>): MsgSubmitActionResponse {
    const message = createBaseMsgSubmitActionResponse();
    message.creator = object.creator ?? '';
    message.actionRequestID = object.actionRequestID !== undefined && object.actionRequestID !== null ? BigInt(object.actionRequestID.toString()) : BigInt(0);
    message.base64NftData = object.base64NftData ?? '';
    return message;
  },
  fromAmino(object: MsgSubmitActionResponseAmino): MsgSubmitActionResponse {
    ...
    if (object.actionRequestID !== undefined && object.actionRequestID !== null) {
      message.actionRequestID = BigInt(object.actionRequestID);
    }
    if (object.base64NftData !== undefined && object.base64NftData !== null) {
      message.base64NftData = object.base64NftData;
    }
  ...
  toAmino(message: MsgSubmitActionResponse): MsgSubmitActionResponseAmino {
    const obj: any = {};
    obj.creator = message.creator === '' ? undefined : message.creator;
    obj.actionRequestID = message.actionRequestID !== BigInt(0) ? (message.actionRequestID?.toString)() : undefined;
    obj.base64NftData = message.base64NftData === '' ? undefined : message.base64NftData;
    return obj;
  },
...
export const MsgSubmitActionResponseResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitActionResponseResponse',
  encode(message: MsgSubmitActionResponseResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const MsgCreateVerifyCollectionOwnerRequest = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateVerifyCollectionOwnerRequest',
  encode(message: MsgCreateVerifyCollectionOwnerRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.nftSchemaCode !== '') {
...
export const MsgCreateVerifyCollectionOwnerRequestResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateVerifyCollectionOwnerRequestResponse',
  encode(message: MsgCreateVerifyCollectionOwnerRequestResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== BigInt(0)) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.nftSchemaCode !== '') {
...
export const MsgSubmitVerifyCollectionOwner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitVerifyCollectionOwner',
  encode(message: MsgSubmitVerifyCollectionOwner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.verifyRequestID !== BigInt(0)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitVerifyCollectionOwner {
    ...
    while (reader.pos < end) {
      ...
      case 1:
        ...
        break;
      case 2:
        message.verifyRequestID = reader.uint64();
        break;
      case 3:
        message.nftSchemaCode = reader.string();
        break;
  ...
  fromPartial(object: Partial<MsgSubmitVerifyCollectionOwner>): MsgSubmitVerifyCollectionOwner {
    const message = createBaseMsgSubmitVerifyCollectionOwner();
    message.creator = object.creator ?? '';
    message.verifyRequestID = object.verifyRequestID !== undefined && object.verifyRequestID !== null ? BigInt(object.verifyRequestID.toString()) : BigInt(0);
    message.nftSchemaCode = object.nftSchemaCode ?? '';
  ...
  fromAmino(object: MsgSubmitVerifyCollectionOwnerAmino): MsgSubmitVerifyCollectionOwner {
    ...
    if (object.verifyRequestID !== undefined && object.verifyRequestID !== null) {
      message.verifyRequestID = BigInt(object.verifyRequestID);
    }
    if (object.nftSchemaCode !== undefined && object.nftSchemaCode !== null) {
      message.nftSchemaCode = object.nftSchemaCode;
    }
  ...
  toAmino(message: MsgSubmitVerifyCollectionOwner): MsgSubmitVerifyCollectionOwnerAmino {
    const obj: any = {};
    obj.creator = message.creator === '' ? undefined : message.creator;
    obj.verifyRequestID = message.verifyRequestID !== BigInt(0) ? (message.verifyRequestID?.toString)() : undefined;
    obj.nftSchemaCode = message.nftSchemaCode === '' ? undefined : message.nftSchemaCode;
...
export const MsgSubmitVerifyCollectionOwnerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitVerifyCollectionOwnerResponse',
  encode(message: MsgSubmitVerifyCollectionOwnerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.verifyRequestID !== BigInt(0)) {
...
export const MsgSetMinimumConfirmation = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSetMinimumConfirmation',
  encode(message: MsgSetMinimumConfirmation, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
...
export const MsgSetMinimumConfirmationResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSetMinimumConfirmationResponse',
  encode(message: MsgSetMinimumConfirmationResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.newConfirmation !== '') {
...
export const MsgCreateActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionSigner',
  encode(message: MsgCreateActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
...
export const MsgCreateActionSignerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionSignerResponse',
  encode(message: MsgCreateActionSignerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.ownerAddress !== '') {
...
export const MsgUpdateActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgUpdateActionSigner',
  encode(message: MsgUpdateActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.base64EncodedSetSignerAction !== '') {
...
export const MsgUpdateActionSignerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgUpdateActionSignerResponse',
  encode(message: MsgUpdateActionSignerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.ownerAddress !== '') {
      writer.uint32(10).string(message.ownerAddress);
    }
    if (message.signerAddress !== '') {
...
export const MsgDeleteActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgDeleteActionSigner',
  encode(message: MsgDeleteActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.base64EncodedSetSignerAction !== '') {
...
export const MsgDeleteActionSignerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgDeleteActionSignerResponse',
  encode(message: MsgDeleteActionSignerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.ownerAddress !== '') {
      writer.uint32(10).string(message.ownerAddress);
    }
    if (message.signerAddress !== '') {
...
export const MsgCreateActionSignerConfig = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionSignerConfig',
  encode(message: MsgCreateActionSignerConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.chain !== '') {
...
export const MsgCreateActionSignerConfigResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateActionSignerConfigResponse',
  encode(message: MsgCreateActionSignerConfigResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chain !== '') {
...
export const MsgUpdateActionSignerConfig = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgUpdateActionSignerConfig',
  encode(message: MsgUpdateActionSignerConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.chain !== '') {
...
export const MsgUpdateActionSignerConfigResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgUpdateActionSignerConfigResponse',
  encode(message: MsgUpdateActionSignerConfigResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chain !== '') {
      writer.uint32(10).string(message.chain);
    }
    if (message.rpcEndpoint !== '') {
...
export const MsgDeleteActionSignerConfig = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgDeleteActionSignerConfig',
  encode(message: MsgDeleteActionSignerConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.chain !== '') {
...
export const MsgDeleteActionSignerConfigResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgDeleteActionSignerConfigResponse',
  encode(message: MsgDeleteActionSignerConfigResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chain !== '') {
      writer.uint32(10).string(message.chain);
    }
    return writer;
...
export const MsgCreateSyncActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateSyncActionSigner',
  encode(message: MsgCreateSyncActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.chain !== '') {
...
export const MsgCreateSyncActionSignerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgCreateSyncActionSignerResponse',
  encode(message: MsgCreateSyncActionSignerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.id !== BigInt(0)) {
      writer.uint32(8).uint64(message.id);
    }
    if (message.chain !== '') {
...
export const MsgSubmitSyncActionSigner = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitSyncActionSigner',
  encode(message: MsgSubmitSyncActionSigner, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.syncId !== BigInt(0)) {
  ...
  fromPartial(object: Partial<MsgSubmitSyncActionSigner>): MsgSubmitSyncActionSigner {
    const message = createBaseMsgSubmitSyncActionSigner();
    message.creator = object.creator ?? '';
    message.syncId = object.syncId !== undefined && object.syncId !== null ? BigInt(object.syncId.toString()) : BigInt(0);
    message.chain = object.chain ?? '';
    message.actorAddress = object.actorAddress ?? '';
    message.ownerAddress = object.ownerAddress ?? '';
  ...
  fromAmino(object: MsgSubmitSyncActionSignerAmino): MsgSubmitSyncActionSigner {
    ...
    if (object.syncId !== undefined && object.syncId !== null) {
      message.syncId = BigInt(object.syncId);
    }
    if (object.chain !== undefined && object.chain !== null) {
      message.chain = object.chain;
    }
  ...
  toAmino(message: MsgSubmitSyncActionSigner): MsgSubmitSyncActionSignerAmino {
    const obj: any = {};
    obj.creator = message.creator === '' ? undefined : message.creator;
    obj.syncId = message.syncId !== BigInt(0) ? (message.syncId?.toString)() : undefined;
    obj.chain = message.chain === '' ? undefined : message.chain;
    obj.actorAddress = message.actorAddress === '' ? undefined : message.actorAddress;
    obj.ownerAddress = message.ownerAddress === '' ? undefined : message.ownerAddress;
...
export const MsgSubmitSyncActionSignerResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.MsgSubmitSyncActionSignerResponse',
  encode(message: MsgSubmitSyncActionSignerResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.verifyRequestID !== BigInt(0)) {
      writer.uint32(8).uint64(message.verifyRequestID);
    }
    if (message.expireAt !== '') {
