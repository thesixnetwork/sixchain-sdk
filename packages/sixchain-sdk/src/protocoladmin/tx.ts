...
export const MsgCreateGroupResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgCreateGroupResponse',
  encode(_: MsgCreateGroupResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdateGroup = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgUpdateGroup',
  encode(message: MsgUpdateGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgUpdateGroupResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgUpdateGroupResponse',
  encode(_: MsgUpdateGroupResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgAddAdminToGroup = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgAddAdminToGroup',
  encode(message: MsgAddAdminToGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgAddAdminToGroupResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgAddAdminToGroupResponse',
  encode(_: MsgAddAdminToGroupResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgRemoveAdminFromGroup = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgRemoveAdminFromGroup',
  encode(message: MsgRemoveAdminFromGroup, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgRemoveAdminFromGroupResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.MsgRemoveAdminFromGroupResponse',
  encode(_: MsgRemoveAdminFromGroupResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
