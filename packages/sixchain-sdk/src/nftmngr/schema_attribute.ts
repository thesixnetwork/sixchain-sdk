...
export const SchemaAttribute = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.SchemaAttribute',
  encode(message: SchemaAttribute, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const SchemaAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.SchemaAttributeValue',
  encode(message: SchemaAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
