...
export const MapTokenToMinter = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.MapTokenToMinter',
  encode(message: MapTokenToMinter, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.tokenId !== '') {
...
export const MetadataCreator = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.MetadataCreator',
  encode(message: MetadataCreator, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
