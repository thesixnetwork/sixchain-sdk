...
export const FeeDistribution = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.FeeDistribution',
  encode(message: FeeDistribution, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.method !== 0) {
...
export const FeeConfig = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.FeeConfig',
  encode(message: FeeConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const NFTFeeConfig = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.NFTFeeConfig',
  encode(message: NFTFeeConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
