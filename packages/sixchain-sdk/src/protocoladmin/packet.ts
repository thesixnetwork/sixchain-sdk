...
export const ProtocoladminPacketData = {
  typeUrl: '/thesixnetwork.sixprotocol.protocoladmin.ProtocoladminPacketData',
  encode(message: ProtocoladminPacketData, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.noData !== undefined) {
      NoData.encode(message.noData, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): ProtocoladminPacketData {
