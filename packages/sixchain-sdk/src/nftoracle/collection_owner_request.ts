...
export const OriginContractParam = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.OriginContractParam',
  encode(message: OriginContractParam, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chain !== '') {
...
export const CollectionOwnerRequest = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.CollectionOwnerRequest',
  encode(message: CollectionOwnerRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const OriginContractInfo = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.OriginContractInfo',
  encode(message: OriginContractInfo, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
