...
export const NFTSchema = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.NFTSchema',
  encode(message: NFTSchema, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.code !== '') {
...
export const NFTSchemaINPUT = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.NFTSchemaINPUT',
  encode(message: NFTSchemaINPUT, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.code !== '') {
      writer.uint32(10).string(message.code);
    }
    if (message.name !== '') {
