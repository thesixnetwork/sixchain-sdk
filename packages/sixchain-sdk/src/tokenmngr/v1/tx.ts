...
export const MsgCreateToken = {
  ...
  fromAmino(object: MsgCreateTokenAmino): MsgCreateToken {
    ...
    if (object.maxSupply !== undefined && object.maxSupply !== null) {
      message.maxSupply = BigInt(object.maxSupply);
    }
  ...
  toAmino(message: MsgCreateToken): MsgCreateTokenAmino {
    ...
    obj.maxSupply = message.maxSupply !== BigInt(0) ? (message.maxSupply?.toString)() : undefined;
...
export const MsgCreateTokenResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgCreateTokenResponse',
  encode(_: MsgCreateTokenResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdateToken = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateToken',
  encode(message: MsgUpdateToken, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgUpdateTokenResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateTokenResponse',
  encode(_: MsgUpdateTokenResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgDeleteToken = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteToken',
  encode(message: MsgDeleteToken, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgDeleteTokenResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteTokenResponse',
  encode(_: MsgDeleteTokenResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgCreateMintperm = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgCreateMintperm',
  encode(message: MsgCreateMintperm, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.token !== '') {
...
export const MsgCreateMintpermResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgCreateMintpermResponse',
  encode(_: MsgCreateMintpermResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdateMintperm = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateMintperm',
  encode(message: MsgUpdateMintperm, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.token !== '') {
...
export const MsgUpdateMintpermResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateMintpermResponse',
  encode(_: MsgUpdateMintpermResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgDeleteMintperm = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteMintperm',
  encode(message: MsgDeleteMintperm, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.token !== '') {
...
export const MsgDeleteMintpermResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteMintpermResponse',
  encode(_: MsgDeleteMintpermResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgMintVersionTwo = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgMintVersionTwo',
  encode(message: MsgMintVersionTwo, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgMintVersionTwo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCreateOptions = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgCreateOptions',
  encode(message: MsgCreateOptions, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
...
export const MsgCreateOptionsResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgCreateOptionsResponse',
  encode(_: MsgCreateOptionsResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdateOptions = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateOptions',
  encode(message: MsgUpdateOptions, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.defaultMintee !== '') {
...
export const MsgUpdateOptionsResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgUpdateOptionsResponse',
  encode(_: MsgUpdateOptionsResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const MsgDeleteOptions = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteOptions',
  encode(message: MsgDeleteOptions, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    return writer;
...
export const MsgDeleteOptionsResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.MsgDeleteOptionsResponse',
  encode(_: MsgDeleteOptionsResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
