...
export const NftAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.NftAttributeValue',
  encode(message: NftAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.name !== '') {
...
export const NumberAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.NumberAttributeValue',
  encode(message: NumberAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const StringAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.StringAttributeValue',
  encode(message: StringAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.value !== '') {
...
export const BooleanAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.BooleanAttributeValue',
  encode(message: BooleanAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const FloatAttributeValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.FloatAttributeValue',
  encode(message: FloatAttributeValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.value !== 0) {
