//@ts-nocheck
import { MsgAddAction, MsgAddAttribute, MsgChangeOrgOwner, MsgChangeSchemaOwner, MsgCreateActionExecutor, MsgCreateMetadata, MsgCreateNFTSchema, MsgDeleteActionExecutor, MsgPerformActionByAdmin, MsgResyncAttributes, MsgSetAttributeOveriding, MsgSetBaseUri, MsgSetFeeConfig, MsgSetMetadataFormat, MsgSetMintauth, MsgSetOriginChain, MsgSetOriginContract, MsgSetUriRetrievalMethod, MsgShowAttributes, MsgToggleAction, MsgUpdateAction,MsgUpdateSchemaAttribute } from './tx';
