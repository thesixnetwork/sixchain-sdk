...
export const MsgSendWrapToken = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.v2.MsgSendWrapToken',
  encode(message: MsgSendWrapToken, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
...
export const MsgSendWrapTokenResponse = {
  typeUrl: '/thesixnetwork.sixprotocol.tokenmngr.v2.MsgSendWrapTokenResponse',
  encode(message: MsgSendWrapTokenResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.receiver !== '') {
