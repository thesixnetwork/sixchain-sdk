...
export const DefaultMintValue = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.DefaultMintValue',
  encode(message: DefaultMintValue, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const AttributeDefinition = {
  typeUrl: '/thesixnetwork.sixnft.nftmngr.AttributeDefinition',
  encode(message: AttributeDefinition, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.name !== '') {
