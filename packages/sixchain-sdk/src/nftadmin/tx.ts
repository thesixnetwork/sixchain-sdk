...
export const MsgGrantPermission = {
  typeUrl: '/thesixnetwork.sixnft.nftadmin.MsgGrantPermission',
  encode(message: MsgGrantPermission, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
...
export const MsgGrantPermissionResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftadmin.MsgGrantPermissionResponse',
  encode(message: MsgGrantPermissionResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.grantee !== '') {
...
export const MsgRevokePermission = {
  typeUrl: '/thesixnetwork.sixnft.nftadmin.MsgRevokePermission',
  encode(message: MsgRevokePermission, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== '') {
...
export const MsgRevokePermissionResponse = {
  typeUrl: '/thesixnetwork.sixnft.nftadmin.MsgRevokePermissionResponse',
  encode(message: MsgRevokePermissionResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.revokee !== '') {
