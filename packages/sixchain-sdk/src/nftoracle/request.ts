...
export const NftOriginData = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.NftOriginData',
  encode(message: NftOriginData, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.image !== '') {
...
export const DataHash = {
  typeUrl: '/thesixnetwork.sixnft.nftoracle.DataHash',
  encode(message: DataHash, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
