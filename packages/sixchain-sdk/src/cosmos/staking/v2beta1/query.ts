...
export const QueryValidatorApprovalRequest = {
  typeUrl: '/cosmos.staking.v2beta1.QueryValidatorApprovalRequest',
  encode(_: QueryValidatorApprovalRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
...
export const QueryValidatorApprovalResponse = {
  typeUrl: '/cosmos.staking.v2beta1.QueryValidatorApprovalResponse',
  encode(message: QueryValidatorApprovalResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const QueryGetWhitelistDelegatorRequest = {
  typeUrl: '/cosmos.staking.v2beta1.QueryGetWhitelistDelegatorRequest',
  encode(message: QueryGetWhitelistDelegatorRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const QueryGetWhitelistDelegatorResponse = {
  typeUrl: '/cosmos.staking.v2beta1.QueryGetWhitelistDelegatorResponse',
  encode(message: QueryGetWhitelistDelegatorResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.whitelistDelegator !== undefined) {
      WhitelistDelegator.encode(message.whitelistDelegator, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetWhitelistDelegatorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAllWhitelistDelegatorRequest = {
  typeUrl: '/cosmos.staking.v2beta1.QueryAllWhitelistDelegatorRequest',
  encode(message: QueryAllWhitelistDelegatorRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.pagination !== undefined) {
...
export const QueryAllWhitelistdelegatorResponse = {
  typeUrl: '/cosmos.staking.v2beta1.QueryAllWhitelistdelegatorResponse',
  encode(message: QueryAllWhitelistdelegatorResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAllWhitelistdelegatorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
