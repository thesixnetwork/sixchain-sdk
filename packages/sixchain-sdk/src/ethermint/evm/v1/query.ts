...
export const EthCallWithOverrideRequest = {
  typeUrl: '/ethermint.evm.v1.EthCallWithOverrideRequest',
  encode(message: EthCallWithOverrideRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.args.length !== 0) {
      writer.uint32(10).bytes(message.args);
    }
    if (message.gasCap !== BigInt(0)) {
...
export const OverrideAccount_StateEntry = {
  encode(message: OverrideAccount_StateEntry, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.key !== '') {
...
export const OverrideAccount_StateDiffEntry = {
  encode(message: OverrideAccount_StateDiffEntry, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.key !== '') {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== '') {
...
export const OverrideAccount = {
  typeUrl: '/ethermint.evm.v1.OverrideAccount',
  encode(message: OverrideAccount, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.nonce !== BigInt(0)) {
...
export const StateOverride_AccountsEntry = {
  encode(message: StateOverride_AccountsEntry, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.key !== '') {
      writer.uint32(10).string(message.key);
    }
...
export const StateOverride = {
  typeUrl: '/ethermint.evm.v1.StateOverride',
  encode(message: StateOverride, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
...
export const BlockOverrides = {
  typeUrl: '/ethermint.evm.v1.BlockOverrides',
  encode(message: BlockOverrides, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.number !== '') {
...
export const TraceCallConfig = {
  typeUrl: '/ethermint.evm.v1.TraceCallConfig',
  encode(message: TraceCallConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.traceConfig !== undefined) {
